...
variable "fw_trust_subnet" {
  description = "The trust subnet of the firewall instance"
  type        = string
}

variable "fw_trust_ip" {
  description = "The IP address of firewall instance trust interface"
  type        = string
}

variable "fw_trust_rule" {
  description = "The GCP firewall rule for the firewall intance trust interface"
  type        = string
}
